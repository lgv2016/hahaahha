...
u8  g_DMA_MiniPC_Reve_Buff[DMA_MiniPC_Reve_Buff_Size];
u8  g_DMA_MiniPC_Send_Buff[DMA_MiniPC_Send_Buff_Size];
...
void BSP_DMA_Init()
{
	...
	//UART8_TX  DMA1 数据流0通道5
    DMA_DeInit(DMA1_Stream0); 
	
    while (DMA_GetCmdStatus(DMA1_Stream0));
    DMA_InitStructure.DMA_Channel                 = DMA_Channel_5;
    DMA_InitStructure.DMA_PeripheralBaseAddr      = (u32)&UART8->DR;
    DMA_InitStructure.DMA_Memory0BaseAddr         = (u32)g_DMA_MiniPC_Send_Buff;
    DMA_InitStructure.DMA_DIR                     = DMA_DIR_MemoryToPeripheral;
    DMA_InitStructure.DMA_BufferSize              = DMA_MiniPC_Send_Buff_Size;
    DMA_InitStructure.DMA_PeripheralInc           = DMA_PeripheralInc_Disable;
    DMA_InitStructure.DMA_MemoryInc               = DMA_MemoryInc_Enable;
    DMA_InitStructure.DMA_PeripheralDataSize      = DMA_PeripheralDataSize_Byte;
    DMA_InitStructure.DMA_MemoryDataSize          = DMA_MemoryDataSize_Byte;
    ...
    //UART8_RX  DMA1 数据流6通道5
    DMA_DeInit(DMA1_Stream6);       
    while (DMA_GetCmdStatus(DMA1_Stream6));
    DMA_InitStructure.DMA_BufferSize              = DMA_MiniPC_Reve_Buff_Size;
    DMA_InitStructure.DMA_Channel                 = DMA_Channel_5;
    DMA_InitStructure.DMA_DIR                     = DMA_DIR_PeripheralToMemory ;
    DMA_InitStructure.DMA_FIFOMode                = DMA_FIFOMode_Disable;
    DMA_InitStructure.DMA_FIFOThreshold           = DMA_FIFOThreshold_Full;
    DMA_InitStructure.DMA_Memory0BaseAddr         = (u32)g_DMA_MiniPC_Reve_Buff;
    DMA_InitStructure.DMA_MemoryBurst             = DMA_MemoryBurst_Single;
    DMA_InitStructure.DMA_MemoryDataSize          = DMA_MemoryDataSize_Byte;
    DMA_InitStructure.DMA_MemoryInc               = DMA_MemoryInc_Enable;
    DMA_InitStructure.DMA_Mode                    = DMA_Mode_Normal;
